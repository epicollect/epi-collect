        ...
        <ul className="faq">
            <li>
                <details>
                    ...
                    <br />
                    <a href="https://www.who.int/features/qa/contact-tracing/en/" target="_blank" rel="noopener">Contact tracing</a> is a way to understand how an infection spreads throughout a population. That information can be used to predict future infections and notify those who may be affected.
                </details>
            </li>
            ...
            <li>
                <details>
                    ...
                    <br/>
                    <br/>
                    Check out our <a href="https://github.com/epicollect/epi-collect/blob/master/PRIVACY.md" target="_blank" rel="noopener">Privacy</a> living document to see how we think about this and how we hope others will too.
                </details>
            </li>
            ...
            <li>
                <details>
                    ...
                    <br/>
                    <ul>
                        <li>We’ve designed our database such that there is no possible way to associate location data with your identity. If you’re an engineer, you can see our very simple database schema <a href="https://github.com/epicollect/epi-collect/blob/master/epi_collect/api/db.py">here</a>.</li>
                    ...
                    <br/>
                    Please see our <a href="https://github.com/epicollect/epi-collect/blob/master/PRIVACY.md" target="_blank" rel="noopener">Privacy</a> living document for more details.
                </details>
            </li>
            ...
            <li>
                <details>
                    ...
                    <br/>
                    <br/>
                    Once you find your Trace Password, you can enter it <a href="https://epi-collect.org/delete">here</a>.
                </details>
            </li>
            ...
            <li>
                <details>
                    ...
                    <br/>
                    Not yet, but it is on our <a href="https://github.com/epicollect/epi-collect/blob/master/ROADMAP.md" target="_blank" rel="noopener">roadmap</a>.
                </details>
            </li>
            ...
            <li>
                <details>
                    ...
                    <br/>
                    Please see our <a href="https://github.com/epicollect/epi-collect/blob/master/RESEARCHERS.md" target="_blank" rel="noopener">document</a> for researchers.
                </details>
            </li>
            ...
            <li>
                <details>
                    ...
                    <br/>
                    Our <a href="https://github.com/epicollect/epi-collect/blob/master/ROADMAP.md" target="_blank" rel="noopener">roadmap</a> lists ways that individual contributors can get involved.
                </details>
            </li>
            ...
            <li>
                <details>
                    ...
                    <br/>
                    Join the <a href="https://join.slack.com/t/epi-collect/shared_invite/zt-d24uxjzl-7oT5ljZwRc74VMgozPwAqg" target="_blank" rel="noopener">Slack workspace</a>, or email core@epi-collect.org.
                </details>
            </li>
        </ul>
    )
